...
CMD_SPEC = (
    ...
    MMLCmd(0x90, 'chanptr',        sections=(SqSection.SEQ,), args=(ArgBits4, ArgChanPtr,)),
    MMLCmd(0xA0, 'rchanptr',       sections=(SqSection.SEQ,), args=(ArgBits4, ArgRelChanPtr,)),
    ...
    MMLCmd(0xEE, 'bend2',             sections=(SqSection.CHAN,), args=(ArgS8,)),
    MMLCmd(0xED, 'gain',              sections=(SqSection.CHAN,), args=(ArgU8,)),
    MMLCmd(0xEC, 'chanreset',         sections=(SqSection.CHAN,)),
    MMLCmd(0xEB, 'bankinstr',         sections=(SqSection.CHAN,), args=(ArgFontId, ArgInstr)),
    MMLCmd(0xEA, 'stop',              sections=(SqSection.CHAN,)),
    MMLCmd(0xE9, 'noteprio',          sections=(SqSection.CHAN,), args=(ArgU8,)),
    ...
    MMLCmd(0xE0, 'volexpr',           sections=(SqSection.CHAN,), args=(ArgU8,)),
    ...
    MMLCmd(0xDC, 'panmix',            sections=(SqSection.CHAN,), args=(ArgU8,)),
    MMLCmd(0xDB, 'transpose',         sections=(SqSection.CHAN,), args=(ArgS8,)),
    MMLCmd(0xDA, 'envelope',          sections=(SqSection.CHAN,), args=(ArgEnvPtr,)),
    ...
    MMLCmd(0xD3, 'bend12',            sections=(SqSection.CHAN,), args=(ArgS8,)),
    ...
    MMLCmd(0xC6, 'bank',              sections=(SqSection.CHAN,), args=(ArgFontId,)),
    ...
    MMLCmd(0xBB, 'chorus',            sections=(SqSection.CHAN,), args=(ArgU8, ArgU16)),
    ...
    MMLCmd(0xA5, 'addchanidx',        sections=(SqSection.CHAN,), args=(),                  version=(MMLVersion.MM,)),
    MMLCmd(0xA4, 'surroundeffectidx', sections=(SqSection.CHAN,), args=(ArgVar,),           version=(MMLVersion.MM,)),
    MMLCmd(0xA3, 'stsfxstateptr',     sections=(SqSection.CHAN,), args=(),                  version=(MMLVersion.MM,)),
    MMLCmd(0xA2, 'stsfxstate',        sections=(SqSection.CHAN,), args=(ArgVar,),           version=(MMLVersion.MM,)),
    MMLCmd(0xA1, 'ldsfxstateptr',     sections=(SqSection.CHAN,), args=(),                  version=(MMLVersion.MM,)),
    MMLCmd(0xA0, 'ldsfxstate',        sections=(SqSection.CHAN,), args=(ArgVar,),           version=(MMLVersion.MM,)),
    # argbits commands
    ...
    MMLCmd(0x20, 'chanptr',           sections=(SqSection.CHAN,), args=(ArgBits4, ArgChanPtr,)),
    ...
    MMLCmd(0x78, 'rlayerptr',         sections=(SqSection.CHAN,), args=(ArgBits3, ArgRelLayerPtr,)),
    MMLCmd(0x80, 'testlayer',         sections=(SqSection.CHAN,), args=(ArgBits3,)),
    MMLCmd(0x88, 'layerptr',          sections=(SqSection.CHAN,), args=(ArgBits3, ArgLayerPtr,)),
    ...
    MMLCmd(0xCB, 'envelope',       sections=(SqSection.LAYER,), args=(ArgEnvPtr, ArgU8,)),
    MMLCmd(0xCC, 'nodrumpan',      sections=(SqSection.LAYER,)),
    MMLCmd(0xCD, 'stereo',         sections=(SqSection.LAYER,), args=(ArgStereoConfig,)),
    MMLCmd(0xCE, 'bend2',          sections=(SqSection.LAYER,), args=(ArgS8,)),
