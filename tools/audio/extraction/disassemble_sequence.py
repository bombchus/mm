...
CMD_SPEC = (
    ...
    #
    MMLCmd(cmd_id=0xFF, mnemonic='end',                               is_flowctrl=True, is_terminal=True, handler=nesting_decr),
    MMLCmd(cmd_id=0xFE, mnemonic='delay1',                            is_flowctrl=True),
    MMLCmd(cmd_id=0xFD, mnemonic='delay',   args=(ArgVar,),           is_flowctrl=True, sections=(SqSection.SEQ, SqSection.CHAN,)),
    MMLCmd(cmd_id=0xFC, mnemonic='call',    args=(ArgBigSectionPtr,), is_flowctrl=True),
    MMLCmd(cmd_id=0xFB, mnemonic='jump',    args=(ArgSectionPtr,),    is_flowctrl=True, is_branch=True, is_branch_unconditional=True),
    MMLCmd(cmd_id=0xFA, mnemonic='beqz',    args=(ArgSectionPtr,),    is_flowctrl=True, is_branch=True),
    MMLCmd(cmd_id=0xF9, mnemonic='bltz',    args=(ArgSectionPtr,),    is_flowctrl=True, is_branch=True),
    MMLCmd(cmd_id=0xF8, mnemonic='loop',    args=(ArgU8,),            is_flowctrl=True, handler=nesting_incr),
    MMLCmd(cmd_id=0xF7, mnemonic='loopend',                           is_flowctrl=True, handler=nesting_decr),
    MMLCmd(cmd_id=0xF6, mnemonic='break',                             is_flowctrl=True, handler=nesting_decr),
    MMLCmd(cmd_id=0xF5, mnemonic='bgez',    args=(ArgSectionPtr,),    is_flowctrl=True, is_branch=True),
    MMLCmd(cmd_id=0xF4, mnemonic='rjump',   args=(ArgRelSectionPtr,), is_flowctrl=True, is_branch=True, is_branch_unconditional=True),
    MMLCmd(cmd_id=0xF3, mnemonic='rbeqz',   args=(ArgRelSectionPtr,), is_flowctrl=True, is_branch=True),
    MMLCmd(cmd_id=0xF2, mnemonic='rbltz',   args=(ArgRelSectionPtr,), is_flowctrl=True, is_branch=True),

    #
    # SEQ commands
    #
    # non-argbits commands
    MMLCmd(cmd_id=0xF1, mnemonic='allocnotelist',  sections=(SqSection.SEQ,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xF0, mnemonic='freenotelist',   sections=(SqSection.SEQ,)),
    MMLCmd(cmd_id=0xEF, mnemonic='unk_EF',         sections=(SqSection.SEQ,), args=(ArgS16, ArgU8,)),
    MMLCmd(cmd_id=0xDF, mnemonic='transpose',      sections=(SqSection.SEQ,), args=(ArgS8,)),
    MMLCmd(cmd_id=0xDE, mnemonic='rtranspose',     sections=(SqSection.SEQ,), args=(ArgS8,)),
    MMLCmd(cmd_id=0xDD, mnemonic='tempo',          sections=(SqSection.SEQ,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xDC, mnemonic='tempochg',       sections=(SqSection.SEQ,), args=(ArgS8,)),
    MMLCmd(cmd_id=0xDB, mnemonic='vol',            sections=(SqSection.SEQ,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xDA, mnemonic='volmode',        sections=(SqSection.SEQ,), args=(ArgU8, ArgS16)),
    MMLCmd(cmd_id=0xD9, mnemonic="volscale",       sections=(SqSection.SEQ,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xD7, mnemonic='initchan',       sections=(SqSection.SEQ,), args=(ArgBitField16,)),
    MMLCmd(cmd_id=0xD6, mnemonic='freechan',       sections=(SqSection.SEQ,), args=(ArgBitField16,)),
    MMLCmd(cmd_id=0xD5, mnemonic='mutescale',      sections=(SqSection.SEQ,), args=(ArgS8,)),
    MMLCmd(cmd_id=0xD4, mnemonic='mute',           sections=(SqSection.SEQ,)),
    MMLCmd(cmd_id=0xD3, mnemonic='mutebhv',        sections=(SqSection.SEQ,), args=(ArgHex8,)),
    MMLCmd(cmd_id=0xD2, mnemonic='ldshortvelarr',  sections=(SqSection.SEQ,), args=(ArgArrayPtr,)), # length 16
    MMLCmd(cmd_id=0xD1, mnemonic='ldshortgatearr', sections=(SqSection.SEQ,), args=(ArgArrayPtr,)), # length 16
    MMLCmd(cmd_id=0xD0, mnemonic='notealloc',      sections=(SqSection.SEQ,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xCE, mnemonic='rand',           sections=(SqSection.SEQ,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xCD, mnemonic='dyncall',        sections=(SqSection.SEQ,), args=(ArgTblPtr,)),
    MMLCmd(cmd_id=0xCC, mnemonic='ldi',            sections=(SqSection.SEQ,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xC9, mnemonic='and',            sections=(SqSection.SEQ,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xC8, mnemonic='sub',            sections=(SqSection.SEQ,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xC7, mnemonic='stseq',          sections=(SqSection.SEQ,), args=(ArgU8, ArgAddr,)),
    MMLCmd(cmd_id=0xC6, mnemonic='stop',           sections=(SqSection.SEQ,)),
    MMLCmd(cmd_id=0xC5, mnemonic='scriptctr',      sections=(SqSection.SEQ,), args=(ArgU16,)),
    MMLCmd(cmd_id=0xC4, mnemonic='runseq',         sections=(SqSection.SEQ,), args=(ArgU8, ArgSeqId,)),
    MMLCmd(cmd_id=0xC3, mnemonic='mutechan',       sections=(SqSection.SEQ,), args=(ArgS16,),                 version=(MMLVersion.MM,)),
    # argbits commands
    MMLCmd(cmd_id=0x00, mnemonic='testchan',       sections=(SqSection.SEQ,), args=(ArgBits4,)),
    MMLCmd(cmd_id=0x40, mnemonic='stopchan',       sections=(SqSection.SEQ,), args=(ArgBits4,)),
    MMLCmd(cmd_id=0x50, mnemonic='subio',          sections=(SqSection.SEQ,), args=(IOPort3,)),
    MMLCmd(cmd_id=0x60, mnemonic='ldres',          sections=(SqSection.SEQ,), args=(ArgBits4, ArgU8, ArgU8,)),
    MMLCmd(cmd_id=0x70, mnemonic='stio',           sections=(SqSection.SEQ,), args=(IOPort3,)),
    MMLCmd(cmd_id=0x80, mnemonic='ldio',           sections=(SqSection.SEQ,), args=(IOPort3,)),
    MMLCmd(cmd_id=0x90, mnemonic='ldchan',         sections=(SqSection.SEQ,), args=(ArgBits4, ArgChanPtr,)),
    MMLCmd(cmd_id=0xA0, mnemonic='rldchan',        sections=(SqSection.SEQ,), args=(ArgBits4, ArgRelChanPtr,)),
    MMLCmd(cmd_id=0xB0, mnemonic='ldseq',          sections=(SqSection.SEQ,), args=(ArgBits4, ArgSeqId, ArgUnkPtr,)),

    #
    # CHAN commands
    #
    # non-argbits commands
    MMLCmd(cmd_id=0xF1, mnemonic='allocnotelist', sections=(SqSection.CHAN,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xF0, mnemonic='freenotelist',  sections=(SqSection.CHAN,)),
    MMLCmd(cmd_id=0xEE, mnemonic='bendfine',      sections=(SqSection.CHAN,), args=(ArgS8,)),
    MMLCmd(cmd_id=0xED, mnemonic='gain',          sections=(SqSection.CHAN,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xEC, mnemonic='vibreset',      sections=(SqSection.CHAN,)),
    MMLCmd(cmd_id=0xEB, mnemonic='fontinstr',     sections=(SqSection.CHAN,), args=(ArgFontId, ArgInstr)),
    MMLCmd(cmd_id=0xEA, mnemonic='stop',          sections=(SqSection.CHAN,)),
    MMLCmd(cmd_id=0xE9, mnemonic='notepri',       sections=(SqSection.CHAN,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xE8, mnemonic='params',        sections=(SqSection.CHAN,), args=(ArgU8, ArgU8, ArgU8, ArgS8, ArgS8, ArgU8, ArgU8, ArgU8,)),
    MMLCmd(cmd_id=0xE7, mnemonic='ldparams',      sections=(SqSection.CHAN,), args=(ArgAddr,)),
    MMLCmd(cmd_id=0xE6, mnemonic='samplebook',    sections=(SqSection.CHAN,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xE5, mnemonic='reverbidx',     sections=(SqSection.CHAN,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xE4, mnemonic='dyncall',       sections=(SqSection.CHAN,)),
    MMLCmd(cmd_id=0xE3, mnemonic='vibdelay',      sections=(SqSection.CHAN,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xE2, mnemonic='vibdepthgrad',  sections=(SqSection.CHAN,), args=(ArgU8, ArgU8, ArgU8,)),
    MMLCmd(cmd_id=0xE1, mnemonic='vibfreqgrad',   sections=(SqSection.CHAN,), args=(ArgU8, ArgU8, ArgU8,)),
    MMLCmd(cmd_id=0xE0, mnemonic='volexp',        sections=(SqSection.CHAN,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xDF, mnemonic='vol',           sections=(SqSection.CHAN,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xDE, mnemonic='freqscale',     sections=(SqSection.CHAN,), args=(ArgU16,)),
    MMLCmd(cmd_id=0xDD, mnemonic='pan',           sections=(SqSection.CHAN,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xDC, mnemonic='panweight',     sections=(SqSection.CHAN,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xDB, mnemonic='transpose',     sections=(SqSection.CHAN,), args=(ArgS8,)),
    MMLCmd(cmd_id=0xDA, mnemonic='env',           sections=(SqSection.CHAN,), args=(ArgEnvPtr,)),
    MMLCmd(cmd_id=0xD9, mnemonic='releaserate',   sections=(SqSection.CHAN,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xD8, mnemonic='vibdepth',      sections=(SqSection.CHAN,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xD7, mnemonic='vibfreq',       sections=(SqSection.CHAN,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xD4, mnemonic='reverb',        sections=(SqSection.CHAN,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xD3, mnemonic='bend',          sections=(SqSection.CHAN,), args=(ArgS8,)),
    MMLCmd(cmd_id=0xD2, mnemonic='sustain',       sections=(SqSection.CHAN,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xD1, mnemonic='notealloc',     sections=(SqSection.CHAN,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xD0, mnemonic='effects',       sections=(SqSection.CHAN,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xCF, mnemonic='stptrtoseq',    sections=(SqSection.CHAN,), args=(ArgAddr,)),
    MMLCmd(cmd_id=0xCE, mnemonic='ldptr',         sections=(SqSection.CHAN,), args=(ArgAddr,)),
    MMLCmd(cmd_id=0xCD, mnemonic='stopchan',      sections=(SqSection.CHAN,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xCC, mnemonic='ldi',           sections=(SqSection.CHAN,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xCB, mnemonic='ldseq',         sections=(SqSection.CHAN,), args=(ArgUnkPtr,)),
    MMLCmd(cmd_id=0xCA, mnemonic='mutebhv',       sections=(SqSection.CHAN,), args=(ArgHex8,)),
    MMLCmd(cmd_id=0xC9, mnemonic='and',           sections=(SqSection.CHAN,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xC8, mnemonic='sub',           sections=(SqSection.CHAN,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xC7, mnemonic='stseq',         sections=(SqSection.CHAN,), args=(ArgU8, ArgAddr,)),
    MMLCmd(cmd_id=0xC6, mnemonic='font',          sections=(SqSection.CHAN,), args=(ArgFontId,)),
    MMLCmd(cmd_id=0xC5, mnemonic='dyntbllookup',  sections=(SqSection.CHAN,)),
    MMLCmd(cmd_id=0xC4, mnemonic='noshort',       sections=(SqSection.CHAN,),                           handler=set_large),
    MMLCmd(cmd_id=0xC3, mnemonic='short',         sections=(SqSection.CHAN,),                           handler=set_short),
    MMLCmd(cmd_id=0xC2, mnemonic='dyntbl',        sections=(SqSection.CHAN,), args=(ArgTblPtr,)),
    MMLCmd(cmd_id=0xC1, mnemonic='instr',         sections=(SqSection.CHAN,), args=(ArgInstr,)),
    MMLCmd(cmd_id=0xBE, mnemonic='unk_BE',        sections=(SqSection.CHAN,), args=(ArgU8,),            version=(MMLVersion.MM,)),
    MMLCmd(cmd_id=0xBD, mnemonic='randptr',       sections=(SqSection.CHAN,), args=(ArgU16, ArgU16,),   version=(MMLVersion.OOT,)),
    MMLCmd(cmd_id=0xBD, mnemonic='samplestart',   sections=(SqSection.CHAN,), args=(ArgU8,),            version=(MMLVersion.MM,)),
    MMLCmd(cmd_id=0xBC, mnemonic='ptradd',        sections=(SqSection.CHAN,), args=(ArgHex16,)),
    MMLCmd(cmd_id=0xBB, mnemonic='combfilter',    sections=(SqSection.CHAN,), args=(ArgU8, ArgU16)),
    MMLCmd(cmd_id=0xBA, mnemonic='randgate',      sections=(SqSection.CHAN,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xB9, mnemonic='randvel',       sections=(SqSection.CHAN,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xB8, mnemonic='rand',          sections=(SqSection.CHAN,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xB7, mnemonic='randtoptr',     sections=(SqSection.CHAN,), args=(ArgU16,)),
    MMLCmd(cmd_id=0xB6, mnemonic='dyntblv',       sections=(SqSection.CHAN,)),
    MMLCmd(cmd_id=0xB5, mnemonic='dyntbltoptr',   sections=(SqSection.CHAN,)),
    MMLCmd(cmd_id=0xB4, mnemonic='ptrtodyntbl',   sections=(SqSection.CHAN,)),
    MMLCmd(cmd_id=0xB3, mnemonic='filter',        sections=(SqSection.CHAN,), args=(ArgU4x2,)),
    MMLCmd(cmd_id=0xB2, mnemonic='ldseqtoptr',    sections=(SqSection.CHAN,), args=(ArgTblPtr,)),
    MMLCmd(cmd_id=0xB1, mnemonic='freefilter',    sections=(SqSection.CHAN,)),
    MMLCmd(cmd_id=0xB0, mnemonic='ldfilter',      sections=(SqSection.CHAN,), args=(ArgFilterPtr,)),
    MMLCmd(cmd_id=0xAA, mnemonic='unk_AA',        sections=(SqSection.CHAN,), args=(),                  version=(MMLVersion.MM,)),
    MMLCmd(cmd_id=0xA8, mnemonic='randptr',       sections=(SqSection.CHAN,), args=(ArgU16, ArgU16,),   version=(MMLVersion.MM,)),
    MMLCmd(cmd_id=0xA7, mnemonic='unk_A7',        sections=(SqSection.CHAN,), args=(ArgVar,),           version=(MMLVersion.MM,)),
    MMLCmd(cmd_id=0xA6, mnemonic='unk_A6',        sections=(SqSection.CHAN,), args=(ArgVar, ArgVar,),   version=(MMLVersion.MM,)),
    MMLCmd(cmd_id=0xA5, mnemonic='unk_A5',        sections=(SqSection.CHAN,), args=(),                  version=(MMLVersion.MM,)),
    MMLCmd(cmd_id=0xA4, mnemonic='unk_A4',        sections=(SqSection.CHAN,), args=(ArgVar,),           version=(MMLVersion.MM,)),
    MMLCmd(cmd_id=0xA3, mnemonic='unk_A3',        sections=(SqSection.CHAN,), args=(),                  version=(MMLVersion.MM,)),
    MMLCmd(cmd_id=0xA2, mnemonic='unk_A2',        sections=(SqSection.CHAN,), args=(ArgVar,),           version=(MMLVersion.MM,)),
    MMLCmd(cmd_id=0xA1, mnemonic='unk_A1',        sections=(SqSection.CHAN,), args=(),                  version=(MMLVersion.MM,)),
    MMLCmd(cmd_id=0xA0, mnemonic='unk_A0',        sections=(SqSection.CHAN,), args=(ArgVar,),           version=(MMLVersion.MM,)),
    # argbits commands
    MMLCmd(cmd_id=0x00, mnemonic='cdelay',        sections=(SqSection.CHAN,), args=(ArgBits4,)),
    MMLCmd(cmd_id=0x10, mnemonic='sample',        sections=(SqSection.CHAN,), args=(ArgBits3, ArgAddr,)),
    MMLCmd(cmd_id=0x18, mnemonic='sampleptr',     sections=(SqSection.CHAN,), args=(ArgBits3, ArgAddr,)),
    MMLCmd(cmd_id=0x20, mnemonic='ldchan',        sections=(SqSection.CHAN,), args=(ArgBits4, ArgChanPtr,)),
    MMLCmd(cmd_id=0x30, mnemonic='stcio',         sections=(SqSection.CHAN,), args=(ArgBits4, IOPort8,)),
    MMLCmd(cmd_id=0x40, mnemonic='ldcio',         sections=(SqSection.CHAN,), args=(ArgBits4, IOPort8,)),
    MMLCmd(cmd_id=0x50, mnemonic='subio',         sections=(SqSection.CHAN,), args=(IOPort3,)),
    MMLCmd(cmd_id=0x60, mnemonic='ldio',          sections=(SqSection.CHAN,), args=(IOPort3,)),
    MMLCmd(cmd_id=0x70, mnemonic='stio',          sections=(SqSection.CHAN,), args=(IOPort3,)),
    MMLCmd(cmd_id=0x78, mnemonic='rldlayer',      sections=(SqSection.CHAN,), args=(ArgBits3, ArgRelLayerPtr,)),
    MMLCmd(cmd_id=0x80, mnemonic='testlayer',     sections=(SqSection.CHAN,), args=(ArgBits3,)),
    MMLCmd(cmd_id=0x88, mnemonic='ldlayer',       sections=(SqSection.CHAN,), args=(ArgBits3, ArgLayerPtr,)),
    MMLCmd(cmd_id=0x90, mnemonic='dellayer',      sections=(SqSection.CHAN,), args=(ArgBits3,)),
    MMLCmd(cmd_id=0x98, mnemonic='dynldlayer',    sections=(SqSection.CHAN,), args=(ArgBits3,)),

    #
    # LAYER commands
    #
    # non-argbits commands
    MMLCmd(cmd_id=0xC0, mnemonic='ldelay',         sections=(SqSection.LAYER,), args=(ArgVar,)),
    MMLCmd(cmd_id=0xC1, mnemonic='shortvel',       sections=(SqSection.LAYER,), args=(ArgU8,)),
    MMLCmd(cmd_id=0xC2, mnemonic='transpose',      sections=(SqSection.LAYER,), args=(ArgS8,)),
    MMLCmd(cmd_id=0xC3, mnemonic='shortdelay',     sections=(SqSection.LAYER,), args=(ArgVar,)),
    MMLCmd(cmd_id=0xC4, mnemonic='legato',         sections=(SqSection.LAYER,)),
    MMLCmd(cmd_id=0xC5, mnemonic='nolegato',       sections=(SqSection.LAYER,)),
    MMLCmd(cmd_id=0xC6, mnemonic='instr',          sections=(SqSection.LAYER,), args=(ArgInstr,)),
    MMLCmd(cmd_id=0xC7, mnemonic='portamento',     sections=(SqSection.LAYER,), args=(ArgPortamentoMode, ArgPitchU8, ArgPortamentoTime,)),
    MMLCmd(cmd_id=0xC8, mnemonic='noportamento',   sections=(SqSection.LAYER,)),
    MMLCmd(cmd_id=0xC9, mnemonic='shortgate',      sections=(SqSection.LAYER,), args=(ArgU8,)),
    ...
    MMLCmd(cmd_id=0xE0, mnemonic='ldshortgate',    sections=(SqSection.LAYER,), args=(ArgBits4,)),
    MMLCmd(cmd_id=0xF0, mnemonic='unk_F0',         sections=(SqSection.LAYER,), args=(ArgS16,),                  version=(MMLVersion.MM,)),
    MMLCmd(cmd_id=0xF1, mnemonic='surroundeffect', sections=(SqSection.LAYER,), args=(ArgU8,),                   version=(MMLVersion.MM,)),
    # argbits commands
    #  large layer
    MMLCmd(cmd_id=0x00, mnemonic='notedvg',        sections=(SqSection.LAYER,), args=(ArgPitch, ArgVar, ArgU8, ArgU8,)),
    MMLCmd(cmd_id=0x40, mnemonic='notedv',         sections=(SqSection.LAYER,), args=(ArgPitch, ArgVar, ArgU8,)),
    MMLCmd(cmd_id=0x80, mnemonic='notevg',         sections=(SqSection.LAYER,), args=(ArgPitch, ArgU8, ArgU8,)),
    #  small layer
    MMLCmd(cmd_id=0x00, mnemonic='shortdvg',       sections=(SqSection.LAYER,), args=(ArgPitch, ArgVar,)),
    MMLCmd(cmd_id=0x40, mnemonic='shortdv',        sections=(SqSection.LAYER,), args=(ArgPitch,)),
    MMLCmd(cmd_id=0x80, mnemonic='shortvg',        sections=(SqSection.LAYER,), args=(ArgPitch,)),
)
